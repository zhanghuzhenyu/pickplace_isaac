...
class UR5Robot(Robot):
    def __init__(self, config: MainConfig, husky_name: str , ur_5_name: str, husky_init_pos: List, world:World) -> None:
        self._config = config
        self.husky_init_pos = husky_init_pos
        self.ur5_init_pos = np.array(self._config.ur5_relative_pose) + self.husky_init_pos,
        self._world = world
        ...
        # print(f"ur_5_prim_path:{self.ur_5_prim_path}")
        usd_path: str = os.path.abspath(self._config.husky_usd_path)
        prim = get_prim_at_path(self.ur_5_prim_path)

        Robot.__init__(self, self.ur_5_prim_path, ur_5_name, position=self.ur5_init_pos, articulation_controller=None)
        
        self._load_ur5(ur_5_name)

        # self.composed_robot = self._make_ur5_bind()
    ...
    def _make_ur5_bind(self):
        ...
        compoeds_robot = composer.compose("/World/husky", 
        "/World/ur5", 
        '/put_ur5', 
        '/base_link', 
