...
file_path = '/home/zhang/.local/share/ov/pkg/isaac_sim-2023.1.0/LLM/replay_data/optimize/episode_2.hdf5'
with h5py.File(file_path, 'r') as file:
    # 读取图像数据
    action_replay_ur5 = file['ur_5_applied_joint_positions'][:]
replay_ts = 0
...
while simulation_app.is_running() and not simulation_app.is_exiting():
    ...
    if my_world.is_playing():
        ...
        for i in range(num_of_tasks):
            ...
            if replay:
                action = action_replay_ur5[replay_ts]
